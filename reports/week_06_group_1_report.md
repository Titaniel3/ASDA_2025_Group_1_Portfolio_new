...
![alt text](../additional_material/Plots/week6_image-1.png)<p>*Figure 3: Correlation Heat Map for environmental sustainabilty*</p>
...
![alt text](../additional_material/Plots/week6_image-2.png)<p>*Figure 4: Scatter Plot for gdp per capita vs. electric power consumption per capita*</p>
...
![alt text](../additional_material/Plots/week6_image-4.png)<p>*Figure 5: Correlation Heat map for economic performance and poverty reduction*</p>

**Correlation 1**: Human Capital vs. Poverty

**Hypothesis**: Higher human capital is correlated with low poverty rates

![alt text](../additional_material/Plots/week6_image-7.png)<p>*Figure 6: Scatter Plot for Human Capital vs. Poverty*</p>
...
![alt text](../additional_material/Plots/week6_image-9.png)<p>*Figure 7: Scatter Plot for Human Capital vs. Life Expectancy at birth*</p>
...
![alt text](../additional_material/Plots/week6_image-10.png)<p>*Figure 8: Scatter Plot for Tax revenue vs. Expenses by government*</p>
...
![alt text](../additional_material/Plots/week6_image-12.png)<p>*Figure 9: Mixed plot for correlations of human well-being and health*</p>

**Descriptive statistics for Birth rate and GDP per Capita**
![alt text](../additional_material/Plots/week6_image-13.png)<p>*Figure 10: Histogram and Boxplot for birth rate and GDP per capita*</p>

**Hypothesis**: Higher GDP per Capita correlates with a lower birth rate

![alt text](../additional_material/Plots/week6_image-14.png)<p>*Figure 11: Scatter Plot for GDP per capita vs. birth rate*</p>
...
We used AI for helping us with the code for more complex visualizations.
